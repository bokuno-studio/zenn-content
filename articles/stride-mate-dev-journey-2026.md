...
|---|---|---|
| Free | 無料 | ¥200分 |
| Standard | ¥1,000 | ¥1,200分 |

AI利用枠は「実際のAPI費用の何倍まで許容するか」で決める。Freeは3.0倍、Standardは2.5倍。

（Standard: ¥1,000 ÷ 2.5 × 3 = ¥1,200分）
...
- Strava連携
- Square課金（月額¥1,000のStandardプラン）
- 使用量ダッシュボード

次にやりたいこと:
- Square Sandboxで課金フローのE2Eテスト
- レース目標管理機能
- 健康診断データの投入

現在、自分と数名の知人だけが使っている段階。需要が確認できたら広げる予定。
